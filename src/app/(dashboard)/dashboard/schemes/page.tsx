...
export default function SchemeEligibilityPage() {
  const schemes = [
    { title: "PM Scholarship Scheme", description: "For Higher Education", icon: <GraduationCap className="w-6 h-6 text-blue-600" />, bg: "bg-blue-50" },
    { title: "Startup India Scheme", description: "For New Businesses", icon: <Briefcase className="w-6 h-6 text-purple-600" />, bg: "bg-purple-50" },
    { title: "Housing for All Scheme", description: "Affordable Home", icon: <Home className="w-6 h-6 text-green-600" />, bg: "bg-green-50" },
  ];
    ...
    <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8">
      ...
      >
        ...
        <form className="space-y-6 bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
          ...
          <button type="button" className="w-full py-4 bg-primary text-white font-bold rounded-xl shadow-md shadow-primary/20 hover:bg-primary/90 hover:scale-[1.02] active:scale-[0.98] transition-all mt-4">
            Check Eligibility
          </button>
        </form>
      </motion.div>
